...
public class ViewPagerActivity extends ActionBarActivity {
    ...
    static ArrayList<ContentItem> getSampleContent() {
        ...
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "c1.png"));
        ...
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "c2.png"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_TEXT, R.string.quote_3));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "c3.png"));
